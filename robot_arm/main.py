...
for i in range(4):
    print('コンベア起動');time.sleep(5);
    if detect_color()=='white':
        initial_servo();IK(0,55.95766,96.46136);
        time.sleep(1);CLOSE_hand();time.sleep(1);
        initial_servo();IK(89.99902,-55.95761,-96.46159);
        time.sleep(1);OPEN_hand();time.sleep(1);
        
    if detect_color()=='black':
        initial_servo();IK(0,55.95766,96.46136);
        time.sleep(1);CLOSE_hand();time.sleep(1);
        initial_servo();IK(-89.99902,-55.9576,-96.4616);
        time.sleep(1);OPEN_hand();time.sleep(1);
        
    
initial_servo();pi.set_mode(servo_pin1, pigpio.INPUT);pi.set_mode(servo_pin2, pigpio.INPUT);pi.set_mode(servo_pin3, pigpio.INPUT);pi.stop();
