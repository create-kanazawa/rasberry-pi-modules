...
class ProcessHandlerByFTP(PatternMatchingEventHandler):
     ...
     status_number = {"nutral":0,
        ...
        "emergency_stop":4}
     status =  1
     target_main = '20211109-servo_test.py'
     target_start = 'func_servo.py'
     target_end = 'stop.py'
     proc = []
     ...
     def start_main_process(self):
         ...
         self.proc = sp.Popen(['python3', self.target_main])
         print("subprocess ID:")
     ...
     def stop_main_process(self):
         try:
             ...
             print("can not kill proccess")             
     def reset_robot(self):
         #self.proc = sp.Popen(['python3', 'scripts/'+self.target_end])
         self.proc = sp.Popen(['python3', '/setting/reset.py'])
     ...
     def action_by_status(self,filename):
         ...
         ##################when file "start" send##################
             ...
             if self.status == self.status_number["wait_start"] or self.status == self.status_number["wait_update"]:
